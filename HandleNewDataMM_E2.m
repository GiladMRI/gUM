...
ScanP='/media/deni/c78a9273-3214-4387-9f72-4cdc3adef255/OnBP_9Aug18/DeeperRegion/';
RefFldMapP='/media/deni/c78a9273-3214-4387-9f72-4cdc3adef255/OnBP_9Aug18/DeeperRegion/meas_MID507_BP_fieldmap_5echosX_FID26075/';
BaseFN='meas_MID517_gBP_ep2d_bold_multiecho_ASL_ppppppppp_FID26085';
...
BaseFN='meas_MID64_gBP_ep2d_SB_U24_VD11_OutInOut_FID27267';


FN=[ScanP BaseFN '.dat'];

%%
mkdir([ScanP BaseFN '_E2']);
...
%%
save([ScanP BaseFN '_E2' filesep 'Data.mat'],'ADataIsL','AData');
...
%%
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep 'Traj'],[]) 
close(gcf);
save([ScanP BaseFN '_E2' filesep 'Traj.mat'],'BARTTrajMS');
disp('Saved traj fig');
...
gStruct2txt(SummaryStr,[ScanP BaseFN '_E2' filesep fileName]);
...
save([ScanP BaseFN '_E2' filesep 'TrajForNUFT.mat'],'Trajm2','SN','Kd','P');
...
%%
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep YLbl '_BARTRecon_NoB0_W' num2str(Lambda) T2SCompStr],[]) 
close(gcf);
save([ScanP BaseFN '_E2' filesep YLbl '_BARTRecon_NoB0_W' num2str(Lambda) T2SCompStr '.mat'],'Rec');
...
%%
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep YLbl '_Params'],[]) 
close(gcf);
disp(['printed fig to file' [ScanP BaseFN '_E2' filesep YLbl '_Params']]);
...
%%
fgmontage(RecS)
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep 'BARTRecon_AllS_NoB0_W' num2str(Lambda) T2SCompStr],[]) 
close(gcf);
save([ScanP BaseFN '_E2' filesep 'BARTRecon_AllS_NoB0_W' num2str(Lambda) T2SCompStr '.mat'],'RecS');

fgmontage(RecSMM)
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep 'BARTRecon2Maps_AllS_NoB0_W' num2str(Lambda) T2SCompStr],[]) 
close(gcf);
save([ScanP BaseFN '_E2' filesep 'BARTRecon2Maps_AllS_NoB0_W' num2str(Lambda) T2SCompStr '.mat'],'RecSMM');
%%
SliI=6;
...
disp('ok');
%%
SliIP=[ScanP BaseFN '_E2' filesep YLbl filesep];
mkdir(SliIP);
...
ylabel(YLbl);
%%
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep YLbl '_' XLbl T2SCompStr],[]) 
close(gcf);
save([ScanP BaseFN '_E2' filesep YLbl '_' XLbl T2SCompStr '.mat'],'im_res');
disp(['Saved ' ScanP BaseFN '_E2' filesep YLbl '_' XLbl T2SCompStr '.mat']);
%% ESPIRIT
...
xlabel(['Daubechies_TI lam ' num2str(lam) ' splitWeight ' num2str(splitWeight)]);
%%
gprint(get(gcf,'Number'),[ScanP BaseFN '_E2' filesep YLbl '_L1ESPIRiT_B0_lam' num2str(lam) T2SCompStr '_CC' num2str(ncc)],[]) 
close(gcf);
save([ScanP BaseFN '_E2' filesep YLbl '_L1ESPIRiT_B0_lam' num2str(lam) T2SCompStr '_CC.mat'],'resL1ESPIRiTCC1');
disp(['Saved ' ScanP BaseFN '_E2' filesep YLbl '_L1ESPIRiT_B0_lam' num2str(lam) T2SCompStr '_CC.mat']);
%% Clean save
% BaseOutLoc='/media/a/DATA/';
SensMsk=single(grmss(SensCC(:,:,:),3)>0.01);
CurOurP=[ScanP BaseFN '_E2' filesep];
mkdir(CurOurP);
CurOurPSli=[ScanP BaseFN '_E2' filesep 'Sli' num2str(SliI,'%02d') filesep];
mkdir(CurOurPSli);
...
%% All reps
CurRealDataP=[ScanP BaseFN '_E2' filesep 'RealData' filesep];
mkdir(CurRealDataP);
for SliI=WhichSlices
    for r=1:nReps
        disp([SliI r]);
...
CurRealDataOutP=[ScanP BaseFN '_E2' filesep 'RealDataOut' filesep];
...
save([ScanP BaseFN '_E2' filesep 'TSBS_TSCS.mat'],'TSBS','TSCS','ErrTSS');
