...
% setting by PNS 95%
% [G6ms{1}, S6ms{1}]=OutInSingleInnerShotf(FOV,ResV(1),VD,3.2,true,InnerShotTime_ms,30,Smax_Tms,GradDwellTime_ms,prisma,PNSThresh,GoldenAngle); 
[G6ms{1}, S6ms{1}]=OutInSingleInnerShotf(FOV,ResV(1),VD,2.9,true,InnerShotTime_ms,30,Smax_Tms,GradDwellTime_ms,prisma,PNSThresh,GoldenAngle); 
...
% [G16ms{1}, S16ms{1}]=OutInSingleInnerShotf(FOV,ResV(1),VD,9.6,true,InnerShotTime_ms,30,Smax_Tms,GradDwellTime_ms,prisma,PNSThresh,GoldenAngle);
[G16ms{1}, S16ms{1}]=OutInSingleInnerShotf(FOV,ResV(1),VD,8.7,true,InnerShotTime_ms,30,Smax_Tms,GradDwellTime_ms,prisma,PNSThresh,GoldenAngle);
