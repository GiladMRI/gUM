...
[G6ms{2}, S6ms{2}]=OutInSingleInnerShotf(FOV,ResV(2),VD,2.07,true,InnerShotTime_ms,Gmax_mTm,Smax_Tms,GradDwellTime_ms,prisma,PNSThresh,GoldenAngle);
...
[G8ms{1}, S8ms{1}]=OutInSingleInnerShotf(FOV,ResV(1),VD,3.95,InnerShotTime_ms,Gmax_mTm,Smax_Tms,GradDwellTime_ms,prisma,PNSThresh,GoldenAngle);
...
tmp=Row(G8ms{2}.*exp(1i*(0:(InnerShotTime_ms-1))*InterShotPhiRad8ms));
gPlotTraj_radm(tmp,FOV,prisma);MaximizeFig;
%%
clear G6msx G8msx
nInnerShots6=8;
