...
save([mainP filesep 'For_NU_MPBD3_S' num2str(SliI) '.mat'],'CurSig','CurKernsA','CurSens','CurTraj',...
    'TotalAcqTime_ms','TE0_ms','THLRMultiShot_RS','Fitted0_RS','sccmtx');
%%
...
St.SessionNameBase=[MIDStr '_ME_S' num2str(SliI)];
