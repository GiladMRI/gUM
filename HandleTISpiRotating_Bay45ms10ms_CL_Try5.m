...
%%
figure;subplot(1,2,1);
gmontage(UpdatedB0Map1,[-100 100]);
title('B_0,T_2^* from TH-LR multi-shot');removeTicks;colorbar
subplot(1,2,2);
gmontage(UpdatedT2SMap_ms1,[0 100]);removeTicks;
%%
...
save([mainP filesep 'PerSlice_gB0.mat'],'Rec_CompgB0_MS','CompsPS');
%%
...
%%
save('Rec_CompgB0_Hyp_Cx3.mat','Rec_CompgB0_Hyp_C','CompsP');
