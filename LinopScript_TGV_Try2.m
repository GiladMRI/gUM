...
%  and applying symmetric differetiation, i.e.
...
figure;
plot(squeeze(DenoisedTGV(64,:,1)),'k');hold on;
plot(squeeze(DenoisedTGVx(64,:,1)),'r');hold on;
plot(squeeze(DenoisedTV(64,:,1)),'k:','LineWidth',2);hold on;
plot(squeeze(DenoisedTVx(64,:,1)),'r:','LineWidth',2);hold on;
