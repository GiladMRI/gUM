...
FNBase='meas_MID01122_FID52604_gep2d_7Shot_Seg32_P1';
FNBase='meas_MID01120_FID52602_gep2d_7Shot_Seg32_P2';
...
%%
try
    SelfSens=RunESPIRiTForSensMapsMultiMap(squeeze(IQQ(:,:,:,12)),0,Sz);
catch
    SelfSens=RunESPIRiTForSensMapsMultiMap(squeeze(IQQ(:,:,:,12)),28,Sz);
end
