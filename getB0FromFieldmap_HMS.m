...
disp('ok t2*');
%%
[PDBase, UpdatedB0Map1, UpdatedT2SMap_ms1, s_vals, Fitted0, PDBase0]=FitToModel_MPBD1CSf(MgAll(:,:,10,:),1:4,dTEs_ms(1),TEs_ms(1));
%%
...
%%
% OneSliceData=squeeze(D(3:end-2,:,1,:,:,9));
% IFOneSliceData=ifft2cg(OneSliceData);