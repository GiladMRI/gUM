...
GT=MmGT.*expPpGT.*expBbGT.*expDdGT;
...
MPBD = MPBDrecon_AopNR_BART_LS(ksp_adj, BARTS_Aop, M, P, B, D, Pm, Pp, Pb, Pd, MPBD, W, niter, ninneriter, dohogwild, 0,GT,BARTS,Inf,AlphaFacMPBD);
%%
...
%%
T2Ss=cat(3,1./dGT,1./MPBD.d,1./d0);
fgmontagex(T2Ss,[0 100],'Size',[1 3]);title('GT                              Decay cycling                            Start point','FontSize',16);
%%
figure;
